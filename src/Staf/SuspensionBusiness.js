...
const history=useHistory()
   ...
   const erreur = () => toast.error("client non trouve!",{
    ...
    const confirmation=e=>{
       ...
       axiosInstance
        .post('staff/verificationbusiness/',{
            phone:data.phone
        })
        .then(res=>{
            history.push(`/confirmationsuspensionbusiness/${res.data.id}/${res.data.prenom+""+res.data.nom}`)  
...
return(
<div>
   <h1 className='container red'> Suspension de compte business</h1>
