 ...
 const retour=()=>{
  history.goBack()
    ...
    return (
        ...
        <h1 className='centerbtn logocolor'>Depot GaalguiMoney</h1>
        <div className='divform'>
     <form className="formdepot" onSubmit={handlesubmit}>
        <div className="w3-section">  
         <p className='centerbtn'> <label><strong>Numero de telephone du client</strong>
         <b className='redstyle'>*</b></label></p>
          <PhoneInput
          countries={["SN"]}
          defaultCountry="SN"
          ...
          <p>
          <input className="w3-input w3-border" type="number" name='somme'
           onChange={handledata}
           min="1"
           onPaste={handlepaste}
