...
function  LesPayementGaalguiShop() {
 ...
 useEffect(()=>{
  ...
  const getachat=()=>{
     axios
  .get('http://127.0.0.1:8000/api/staff/getlespayementsgaalguishop/',
    {headers:{
...
const handlerelever=id=>{
  axiosInstance
  .post('staff/releverpayementgaalguishop/',{id:id})
  .then(res=>{
    getachat()
  })
}
...
const handledisplay=(data)=>{
 ...
 return(
  ...
  <h4 className='centerbtn'>Les achats GaalguiShop</h4>
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right" scope="row">Commission(CFA)</TableCell>
...
export default LesPayementGaalguiShop